...
var attrSeeker = /* @__PURE__ */ new RegExp("<([A-Za-z$#]+[A-Za-z0-9:_-]*)((?:[  \\f\\n\\r\\t]+(?:use:<!--#-->|[^ \\f\\n\\r\\t\\/>\"'=]+)(?:\\s*=\\s*(?:'[^']*?'|\"[^\"]*?\"|\\([^)]*?\\)|<[^>]*?>|[^ \\f\\n\\r\\t\\/>\"'=]+))?)+)([  \\f\\n\\r\\t]*/?>)", "g");
var findAttributes = /* @__PURE__ */ new RegExp("([  \\f\\n\\r\\t]+(?:use:<!--#-->|[^ \\f\\n\\r\\t\\/>\"'=]+)\\s*=\\s*)(<!--#-->|['\"(]([\\w\\s]*<!--#-->[\\w\\s]*)*['\")])", "gi");
var selfClosing = /* @__PURE__ */ new RegExp("<([A-Za-z$#]+[A-Za-z0-9:_-]*)((?:[  \\f\\n\\r\\t]+(?:use:<!--#-->|[^ \\f\\n\\r\\t\\/>\"'=]+)(?:\\s*=\\s*(?:'[^']*?'|\"[^\"]*?\"|\\([^)]*?\\)|<[^>]*?>|[^ \\f\\n\\r\\t\\/>\"'=]+))?)*)([  \\f\\n\\r\\t]*/>)", "g");
var marker = "<!--#-->";
